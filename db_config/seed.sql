...
('Accra Banana', 'Spicy banana fritters made from overripe bananas, commonly served with hot pepper sauce', 'https://res.cloudinary.com/drs0ewxd1/image/upload/v1/cameroon-recipes/breakfast/accra-banana.png', 1),
('Beans and Plantains', 'Boiled beans served with fried ripe plantains, a nutritious and filling breakfast', 'https://res.cloudinary.com/drs0ewxd1/image/upload/v1/cameroon-recipes/breakfast/beans-ripe-plantain.png', 1),
...
('Fufu and Eru', 'A traditional dish from the Southwest - finely shredded eru leaves cooked with waterleaf, crayfish, and palm oil', 'https://res.cloudinary.com/drs0ewxd1/image/upload/v1/cameroon-recipes/lunch/eru.jpeg', 2),
...
(1, 'All-purpose flour', '3', 'cups', TRUE),
(1, 'Sugar', '1/2', 'cup', TRUE),
(1, 'Active dry yeast', '2', 'teaspoons', TRUE),
(1, 'Warm water', '1.5', 'cups', TRUE),
(1, 'Salt', '1/4', 'teaspoon', FALSE),
(1, 'Nutmeg', '1/4', 'teaspoon', FALSE),
(1, 'Vegetable oil', '4', 'cups (for frying)', TRUE)
ON CONFLICT DO NOTHING;
...
(1, 8, 'Serve warm, optionally with beans or as a standalone snack. Cultural note: Puff puff is often sold by street vendors throughout the day')
ON CONFLICT DO NOTHING;

-- Recipe 2: Accra Banana
INSERT INTO ingredients (recipe_id, name, quantity, unit, is_main) VALUES
(2, 'Overripe plantains', '4', 'medium', TRUE),
(2, 'All-purpose flour', '1/2', 'cup', TRUE),
(2, 'Onion', '1', 'small, finely chopped', TRUE),
(2, 'Fresh pepper (scotch bonnet)', '1', 'small, minced', TRUE),
(2, 'Ginger', '1', 'teaspoon, grated', FALSE),
(2, 'Salt', '1', 'teaspoon', FALSE),
(2, 'Vegetable oil', '3', 'cups (for frying)', TRUE)
ON CONFLICT DO NOTHING;

INSERT INTO instructions (recipe_id, step_number, description) VALUES
(2, 1, 'Peel the overripe bananas/plantains and mash them thoroughly in a large bowl'),
(2, 2, 'Add the grated cassava and salt to the mashed bananas/plantains'),
(2, 3, 'Mix everything together until well combined and smooth'),
(2, 4, 'Heat oil in a deep frying pan over medium-high heat'),
(2, 5, 'Scoop tablespoon-sized portions of the mixture, roll them into balls, and carefully drop into the hot oil'),
...
INSERT INTO ingredients (recipe_id, name, quantity, unit, is_main) VALUES
(3, 'Beans', '2', 'cups', TRUE),
(3, 'Ripe plantains', '3', 'large', TRUE),
(3, 'Palm oil', '3', 'tablespoons', TRUE),
(3, 'Onion', '1', 'medium, chopped', TRUE),
(3, 'Salt', '2', 'teaspoons', FALSE),
(3, 'Crayfish', '2', 'tablespoons, ground', FALSE),
(3, 'Maggi cubes', '2', 'cubes', FALSE),
(3, 'Water', '6', 'cups', TRUE)
ON CONFLICT DO NOTHING;
...
INSERT INTO ingredients (recipe_id, name, quantity, unit, is_main) VALUES
(4, 'White yam', '1', 'medium (about 2 lbs)', TRUE),
(4, 'Eggs', '4', 'large', TRUE),
(4, 'Onion', '1', 'medium, chopped', TRUE),
(4, 'Tomatoes', '2', 'medium, diced', TRUE),
(4, 'Fresh pepper', '1', 'small, minced', TRUE),
(4, 'Vegetable oil', '3', 'tablespoons', TRUE),
(4, 'Salt', '1', 'teaspoon', FALSE),
(4, 'Maggi cube', '1', 'cube', FALSE),
(4, 'Water', '8', 'cups', TRUE)
ON CONFLICT DO NOTHING;
...
INSERT INTO ingredients (recipe_id, name, quantity, unit, is_main) VALUES
(5, 'Ndolé leaves (bitter leaves)', '2', 'lbs, washed and chopped', TRUE),
(5, 'Raw groundnuts (peanuts)', '2', 'cups', TRUE),
(5, 'Groundnut paste', '1', 'cup', TRUE),
(5, 'Beef', '1', 'lb, cut into chunks', TRUE),
(5, 'Meat (optional)', '1', 'lb, cut into chunks', FALSE),
(5, 'Smoked fish (optional)', '2', 'pieces', FALSE),
(5, 'Shrimp (optional)', '1', 'cup, shelled and deveined', FALSE),
(5, 'Crayfish (ground)', '1/2', 'cup', FALSE),
(5, 'Palm oil', '1/2', 'cup', TRUE),
(5, 'Vegetable oil', '1/2', 'cup', TRUE),
(5, 'Onions', '2', 'medium, chopped', TRUE),
(5, 'Garlic', '4', 'cloves, minced', FALSE),
(5, 'Maggi cubes', '3', 'cubes', FALSE),
(5, 'Salt', '2', 'teaspoons', FALSE),
(5, 'Water', '4', 'cups', TRUE)
ON CONFLICT DO NOTHING;

INSERT INTO instructions (recipe_id, step_number, description) VALUES
(5, 1, 'Boil ndolé leaves in water for 15 minutes to reduce bitterness, then drain and squeeze out excess water. Repeat if needed until leaves are less bitter'),
...
-- Recipe 6: fufu and Eru
INSERT INTO ingredients (recipe_id, name, quantity, unit, is_main) VALUES
(6, 'Eru leaves', '1', 'lb, finely shredded', TRUE),
(6, 'Waterleaf (or spinach)', '1', 'lb, chopped', TRUE),
(6, 'Smoked fish', '2', 'pieces', TRUE),
(6, 'Beef', '2', 'pieces', TRUE),
(6, 'Stockfish', '1', 'piece, soaked', TRUE),
(6, 'Crayfish', '1/2', 'cup, ground', FALSE),
(6, 'Palm oil', '1/2', 'cup', TRUE),
(6, 'Pepper', '2', 'teaspoons', FALSE),
(6, 'Maggi cubes', '2', 'cubes', FALSE),
(6, 'Salt', '1', 'teaspoon', FALSE),
(6, 'Water', '2', 'cups', TRUE),
(6, 'Water fufu', '1', 'portion', TRUE)
ON CONFLICT DO NOTHING;
...
INSERT INTO ingredients (recipe_id, name, quantity, unit, is_main) VALUES
(7, 'Whole chicken', '1', 'medium, cut into pieces', TRUE),
(7, 'Onions', '2', 'large, sliced', TRUE),
(7, 'Garlic', '6', 'cloves, minced', FALSE),
(7, 'Ginger', '2', 'tablespoons, grated', FALSE),
(7, 'Fresh pepper', '3', 'pieces, blended', TRUE),
(7, 'Palm oil', '1/4', 'cup', TRUE),
(7, 'Maggi cubes', '3', 'cubes', FALSE),
(7, 'Paprika', '1', 'tablespoon', FALSE),
(7, 'Salt', '2', 'teaspoons', FALSE),
(7, 'Tomatoes', '4', 'large, diced (for sauce)', FALSE),
(7, 'Corn flour', '3', 'a few cups (for cooking)', TRUE)
ON CONFLICT DO NOTHING;
...
(7, 11, 'Cultural note: Kati Kati is a popular dish at Cameroonian restaurants and open-air grills, especially in urban areas. The name comes from the crackling sound of chicken on the grill')
ON CONFLICT DO NOTHING;

-- Recipe 8: Achu Soup (Yellow Soup)
INSERT INTO ingredients (recipe_id, name, quantity, unit, is_main) VALUES
(8, 'Palm oil', '1', 'cup', TRUE),
(8, 'Limestone (kanwa)', '1', 'tablespoon', TRUE),
(8, 'Water', '3', 'cups', TRUE),
(8, 'Beef', '1', 'lb, cut into chunks', TRUE),
(8, 'Tripe (cow leg)', '1/2', 'lb', FALSE),
(8, 'Smoked fish', '2', 'pieces', FALSE),
(8, 'achu soup spice mix', '3', 'tablespoons, ground', TRUE),
(8, 'Basil leaves', '1', 'cup, chopped', FALSE),
(8, 'Maggi cubes', '3', 'cubes', FALSE),
(8, 'Salt', '2', 'teaspoons', FALSE),
(8, 'Cocoyam', '6', 'medium (for pounding)', TRUE)
ON CONFLICT DO NOTHING;
...
INSERT INTO ingredients (recipe_id, name, quantity, unit, is_main) VALUES
(9, 'Long grain rice', '4', 'cups', TRUE),
(9, 'Tomato paste', '1', 'can (6 oz)', TRUE),
(9, 'Fresh tomatoes', '6', 'large, blended', TRUE),
(9, 'peppers', '3', 'large, blended', TRUE),
(9, 'Onions', '2', 'large, chopped', TRUE),
(9, 'Chicken or beef', '2', 'lbs, cut into pieces', FALSE),
(9, 'Vegetable oil', '1/2', 'cup', TRUE),
(9, 'Chicken stock', '5', 'cups', FALSE),
(9, 'Garlic', '4', 'cloves, minced', FALSE),
(9, 'Ginger', '1', 'tablespoon, grated', FALSE),
(9, 'Thyme', '1', 'teaspoon', FALSE),
(9, 'Curry powder', '1', 'tablespoon', FALSE),
(9, 'Bay leaves', '3', 'pieces', FALSE),
(9, 'Maggi cubes', '4', 'cubes', FALSE),
(9, 'Salt', '2', 'teaspoons', FALSE)
ON CONFLICT DO NOTHING;
...
(10, 'Beef', '1', 'lb, cubed', TRUE),
(10, 'Dried fish', '2', 'pieces', TRUE),
(10, 'Crayfish', '1/4', 'cup, ground', FALSE),
(10, 'Pumpkin leaves', '4', 'cups, chopped', FALSE),
(10, 'Onion', '1', 'large, chopped', TRUE),
(10, 'Fresh pepper', '2', 'tablespoons, blended', FALSE),
(10, 'Maggi cubes', '3', 'cubes', FALSE),
(10, 'Salt', '2', 'teaspoons', FALSE),
(10, 'Water', '4', 'cups', TRUE)
ON CONFLICT DO NOTHING;

INSERT INTO instructions (recipe_id, step_number, description) VALUES
(10, 1, 'Season and boil beef until tender with onions and Maggi cubes'),
(10, 2, 'In a separate bowl, mix ground egusi with a little water to form a paste'),
(10, 3, 'Heat palm oil in a large pot and fry the egusi paste for 5 minutes, stirring constantly'),
(10, 4, 'Add the meat stock gradually while stirring to prevent lumps'),
(10, 5, 'Add boiled meat, dried fish, ground crayfish, and pepper'),
(10, 6, 'Add more water to reach desired consistency and bring to a boil'),
(10, 7, 'Simmer for 15 minutes, then add chopped pumpkin leaves'),
(10, 8, 'Cook for 5 more minutes until vegetables are tender'),
(10, 9, 'Adjust seasoning with salt and Maggi cubes'),
(10, 10, 'Serve hot with fufu, garri, or pounded yam'),
(10, 11, 'Cultural note: Egusi soup is popular throughout Cameroon and is often served at gatherings. The melon seeds provide protein and a unique nutty flavor')
ON CONFLICT DO NOTHING;
...
(11, 'Fresh pepper', '3', 'pieces, chopped', TRUE),
(11, 'Onions', '1', 'large, sliced', TRUE),
(11, 'Garlic', '4', 'cloves, minced', FALSE),
(11, 'Ginger', '2', 'tablespoons, grated', FALSE),
(11, 'Scent leaves (basil)', '1', 'cup, chopped', FALSE),
(11, 'Maggi cubes', '3', 'cubes', FALSE),
(11, 'Salt', '1', 'teaspoon', FALSE),
(11, 'Water', '6', 'cups', TRUE),
(11, 'Njangsang', '3', 'seeds', TRUE)
ON CONFLICT DO NOTHING;

INSERT INTO instructions (recipe_id, step_number, description) VALUES
(11, 1, 'Clean fish thoroughly and set aside'),
(11, 2, 'In a pot, add water, onions, garlic, ginger, pepper, njangsang and pepper soup spice'),
(11, 3, 'Bring to a boil and simmer for 10 minutes to infuse flavors'),
(11, 4, 'Add Maggi cubes and salt, stir well'),
(11, 5, 'Add fish pieces carefully to avoid breaking them'),
(11, 6, 'Simmer for 10-15 minutes until fish is cooked through'),
(11, 7, 'Add chopped scent leaves and turn off heat'),
(11, 8, 'Let it sit covered for 5 minutes to allow flavors to meld'),
(11, 9, 'Serve hot in bowls, optionally with boiled plantains or yam on the side'),
...
(12, 'Stockfish', '2', 'pieces, soaked', TRUE),
(12, 'Crayfish', '1/2', 'cup, ground', FALSE),
(12, 'Bitter leaf', '2', 'cups, washed and chopped', TRUE),
(12, 'Fresh pepper', '2', 'tablespoons, blended', FALSE),
(12, 'Onion', '1', 'large, chopped', FALSE),
(12, 'Maggi cubes', '3', 'cubes', FALSE),
(12, 'Salt', '2', 'teaspoons', FALSE),
(12, 'Water', '4', 'cups', TRUE)
ON CONFLICT DO NOTHING;

INSERT INTO instructions (recipe_id, step_number, description) VALUES
(12, 1, 'Boil palm nuts until soft, pound or blend, then extract the cream by adding water and straining'),
(12, 2, 'Pour palm nut cream into a pot and bring to a boil'),
(12, 3, 'Add onions, ground crayfish, and pepper, stir well'),
(12, 4, 'Add smoked fish and soaked stockfish to the pot'),
(12, 5, 'Season with Maggi cubes and salt'),
(12, 6, 'Simmer for 20 minutes, stirring occasionally to prevent sticking'),
(12, 7, 'Add bitter leaves and cook for 10 more minutes'),
(12, 8, 'The soup should be thick and oily on top'),
(12, 9, 'Serve hot with fufu, rice, or boiled plantains'),
...
(13, 'Smoked fish', '2', 'pieces', TRUE),
(13, 'Crayfish', '1/3', 'cup, ground', TRUE),
(13, 'Palm oil', '1/4', 'cup', TRUE),
(13, 'Onion', '1', 'medium, chopped', TRUE),
(13, 'Fresh pepper', '2', 'tablespoons', FALSE),
(13, 'Maggi cubes', '3', 'cubes', FALSE),
(13, 'Salt', '1', 'teaspoon', FALSE),
(13, 'Water', '4', 'cups', TRUE)
ON CONFLICT DO NOTHING;

INSERT INTO instructions (recipe_id, step_number, description) VALUES
(13, 1, 'Season and boil beef until tender'),
(13, 2, 'In a pot, heat palm oil and sauté onions until soft'),
(13, 3, 'Add the boiled beef with some stock, smoked fish, ground crayfish, and pepper'),
(13, 4, 'Add water and bring to a boil'),
(13, 5, 'Add the chopped or blended okra and stir well'),
(13, 6, 'Season with Maggi cubes and salt'),
(13, 7, 'Simmer on low heat for 15 minutes, stirring occasionally'),
(13, 8, 'The soup will become slimy and thick - this is the desired texture'),
(13, 9, 'Serve hot with garri, fufu, or boiled yam'),
(13, 10, 'Cultural note: Okra soup is popular across Cameroon and is valued for its health benefits. The slimy texture aids digestion')
ON CONFLICT DO NOTHING;
...
(14, 'Sugar', '1/4', 'cup', TRUE),
(14, 'Egg', '1', 'large', TRUE),
(14, 'Vanilla extract', '1', 'teaspoon', FALSE),
(14, 'Cinnamon', '1/2', 'teaspoon', FALSE),
(14, 'Salt', '1/4', 'teaspoon', FALSE),
(14, 'Vegetable oil', '3', 'cups (for frying)', TRUE),
(14, 'Powdered sugar', '2', 'tablespoons (for dusting)', FALSE)
ON CONFLICT DO NOTHING;

INSERT INTO instructions (recipe_id, step_number, description) VALUES
(14, 1, 'Mash the ripe bananas in a bowl until smooth'),
(14, 2, 'Add egg, sugar, vanilla extract, cinnamon, and salt to the mashed bananas, mix well'),
(14, 3, 'Gradually fold in the flour until you have a thick batter'),
(14, 4, 'Heat oil in a deep pan over medium-high heat'),
(14, 5, 'Drop spoonfuls of batter into the hot oil'),
(14, 6, 'Fry until golden brown on both sides (about 2-3 minutes per side)'),
(14, 7, 'Remove and drain on paper towels'),
(14, 8, 'While still warm, dust with powdered sugar'),
(14, 9, 'Serve warm as a dessert or afternoon snack'),
